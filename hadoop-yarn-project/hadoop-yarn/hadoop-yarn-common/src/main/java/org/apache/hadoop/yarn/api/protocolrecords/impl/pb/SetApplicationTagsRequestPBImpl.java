...
import org.apache.hadoop.yarn.proto.YarnServiceProtos.SetApplicationTagsRequestProto;
import org.apache.hadoop.yarn.proto.YarnServiceProtos.SetApplicationTagsRequestProtoOrBuilder;
...
@Private
@Unstable
public class SetApplicationTagsRequestPBImpl extends SetApplicationTagsRequest {
  private static volatile Boolean forceLowerCaseTags;
  SetApplicationTagsRequestProto proto = SetApplicationTagsRequestProto.getDefaultInstance();
  SetApplicationTagsRequestProto.Builder builder = null;
  ...
  public SetApplicationTagsRequestPBImpl() {
    builder = SetApplicationTagsRequestProto.newBuilder();
    initLowerCaseConfig();
  }

  public SetApplicationTagsRequestPBImpl(SetApplicationTagsRequestProto proto) {
    this.proto = proto;
    viaProto = true;
    initLowerCaseConfig();
  }
  ...
  public SetApplicationTagsRequestProto getProto() {
    mergeLocalToProto();
  ...
  private void maybeInitBuilder() {
    if (viaProto || builder == null) {
      builder = SetApplicationTagsRequestProto.newBuilder(proto);
    }
    viaProto = false;
  }
  ...
  public ApplicationId getApplicationId() {
    SetApplicationTagsRequestProtoOrBuilder p = viaProto ? proto : builder;
    if (this.applicationId != null) {
